...
async function getPokemonCustom(input) {   //all parameters in Javascript are optional, will be undefined if not specified
    if (!isNaN(input)) { //need to catch error another way, throw?
